...
function GetUrl(url) {
  ...
  GetUrl("http://192.168.43.99/reload_ref");
...
//METRICAS
  ...
  ways.forEach((url_name) => {
    ...
    xhttp.open("GET", "http://192.168.43.99/" + url_name + "_value", true);
    xhttp.send();
...
console.log($(".no_alerts").siblings() )
 ...
 //apikey: 0d89eff8-78bc-409a-8c4b-821247d91971
    if (qtdFoodReservoir< 0.1) {  fetch('https://api.mynotifier.app', { method: 'POST' , headers: { 'Content-Type' : 'application/json'
