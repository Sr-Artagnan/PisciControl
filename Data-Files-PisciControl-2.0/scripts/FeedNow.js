...
console.log(typeof parseFloat(amountFoodInput.val()))
  ...
  let request = new XMLHttpRequest()
  request.open("GET", "http://192.168.43.99/ledon" + "?foodprovided=" + amountFoodInput.val(), false) // url para ligar o motor
  request.send();
...
openRotor()
  ...
  setInterval(function ( ) {
    ...
    xhttp.open("GET", "http://192.168.43.99/temp_value", true);
    xhttp.send();
