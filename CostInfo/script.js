...
let tca = 0
if (weight < 10) { tca=1}; if (weight>= 10 && weight < 50) { tca=1.1} if (weight>= 50 && weight < 150) { tca=1.2} if
            (weight>= 150 && weight < 250) { tca=1.3} if (weight>= 250 && weight < 400) { tca=1.4} if (weight>= 400 &&
                    weight < 600) { tca=1.6} if (weight>= 600 && weight < 800) { tca=1.7} if (weight>= 800 && weight <
                                1300) { tca=1.8} if (weight> 1300) { tca = 2}
                                ...
                                lastDate.value = "Data: " + new Date(date2).getDate().toString() + "/" + new
                                Date(date2).getMonth().toString() + "/" + new Date(date2).getFullYear().toString();
                                penultDate.value = "Data: " + new Date(date1).getDate().toString() + "/" + new
                                Date(date1).getMonth().toString() + "/" + new Date(date1).getFullYear().toString();
                                ...
                                postWeight1(new Date(penultDate.value), penultWeight.value, function (value)
                                 {
                                    setTimeout(()=> {
                                        postWeight2(new Date(lastDate.value), lastWeight.value, function
                                (value) {
                                        });
                                    }, 1000) 
                                });
                                ...
                                item.timestamp = time.getDate().toString() + "/" + (time.getMonth()+1).toString() + "/"
                                ...
                                TCAReal.innerHTML = "&nbsp" + parseFloat(LastDayFood / ((WeightGain / 1000) * amountFish)).toFixed(2)
                                console.log(FoodPerDay);
                                }, 2500);
                                }
                                TCA();
                                ...
                                const startIndex = array.length >= 7 ? array.length - 7 : array.length - array.length;
                                const values = array.map((item, index) => index >= startIndex && item.value);
                                ...
                                relativeCostOutput.innerHTML = "&nbsp" + parseFloat(Result / (WeightGain * amountFish *
                                7 / 1000)).toFixed(2)
                                }
